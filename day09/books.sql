...
CREATE TABLE `图书` (
  ...
  KEY `a_id` (`a_id`),
  KEY `p_id` (`p_id`),
  CONSTRAINT `图书_ibfk_1` FOREIGN KEY (`a_id`) REFERENCES `作家` (`id`),
  CONSTRAINT `图书_ibfk_2` FOREIGN KEY (`p_id`) REFERENCES `出版社` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `author_publication` (
  ...
  KEY `aid` (`aid`),
  KEY `pid` (`pid`),
  CONSTRAINT `author_publication_ibfk_1` FOREIGN KEY (`aid`) REFERENCES `作家` (`id`),
  CONSTRAINT `author_publication_ibfk_2` FOREIGN KEY (`pid`) REFERENCES `出版社` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `book` (
  ...
  `publication` varchar(50) DEFAULT NULL COMMENT '出版社',
...
INSERT INTO `book` VALUES (1,'边城','沈从文','机械工业出版社',36.00,'2020-01-01','小城故事多'),(2,'骆驼祥子','老舍','机械工业出版社',48.00,'2016-10-01','你是祥子么'),(3,'茶馆','老舍','中国文学出版社',60.00,'2016-10-01','老北京'),(4,'呐喊','鲁迅','人民教育出版社',51.00,'2020-01-01','最后的声音'),(5,'朝花夕拾','鲁迅','中国文学出版社',53.00,'2018-10-01','好时光'),(6,'围城','钱钟书','人民教育出版社',44.00,'2020-01-01','你心中的围城是什么'),(7,'林家铺子','茅盾','中国文学出版社',51.00,'2018-10-01',NULL),(8,'巨人传','忘了','人民教育出版社',47.00,'2020-01-01',NULL);
...
INSERT INTO `test` VALUES (1,'a1',2),(2,'a2',3);
...
-- Dump completed on 2020-08-07 14:36:08
